...
public final class MekanicalCreatePonderPlugin implements PonderPlugin {
    ...
    public void registerScenes(PonderSceneRegistrationHelper<ResourceLocation> helper) {
        helper.forComponents(
                        ModBlocks.FLUID_MEKANICAL_FACTORY.getRegistryName(),
                        ModBlocks.MEKANICAL_FACTORY_CASING.getRegistryName(),
                        MekanismBlocks.STRUCTURAL_GLASS.getRegistryName(),
                        ModBlocks.MEKANICAL_FACTORY_PORT.getRegistryName(),
                        ModBlocks.MEKANICAL_FACTORY_SPEED_CORE.getRegistryName(),
                        ModBlocks.MEKANICAL_FACTORY_ENERGY_CORE.getRegistryName(),
                        ModBlocks.MEKANICAL_FACTORY_FLUID_CORE.getRegistryName(),
                        ModBlocks.MEKANICAL_FACTORY_CATALYST_CORE.getRegistryName())
