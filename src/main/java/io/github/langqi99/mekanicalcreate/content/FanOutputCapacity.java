...
final class FanOutputCapacity {
    ...
    private static final class ItemKey {
        ...
        private ItemKey(ItemStack exemplar) {
            this.exemplar = exemplar.copy();
            this.exemplar.setCount(1);
            hash = Objects.hash(this.exemplar.getItem(), this.exemplar.getTag());
        }

        @Override
        public boolean equals(Object other) {
            return this == other || other instanceof ItemKey key
                    && ItemStack.isSameItemSameTags(exemplar, key.exemplar);
        }
